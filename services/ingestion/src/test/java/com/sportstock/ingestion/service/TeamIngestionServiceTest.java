...
class TeamIngestionServiceTest {
  ...
  @Mock private TeamRecordRepository teamRecordRepository;
  ...
  void ingestTeamDetailUsesFullLengthRecordTypeForLookupAndSave() throws Exception {
    ...
    when(teamRecordRepository.save(any(TeamRecord.class)))
    ...
    org.junit.jupiter.api.Assertions.assertEquals(
        longRecordType, recordCaptor.getValue().getRecordType());
  }
