...
public class WeeklyLifecycleJob {
    ...
    public void run() {
        ...
        try {
            ...
            log.info(
                    ...
                    seasonYear, seasonType, currentWeekNum);
            ...
            if (priorWeek != null) {
                ...
                log.info("Prior week: season {}/{} week {}", priorSeasonYear, priorSeasonType, priorWeekNum);
            ...
            if (canDelist) {
                try {
                    int delisted = stockMarketClient.delistUnprojectedStocks(seasonYear, seasonType, currentWeekNum);
            ...
            if (priorWeek != null) {
                clearPriorWeekEventStates(
                        priorWeek.week(),
                        priorWeek.seasonYear(),
                        Integer.parseInt(priorWeek.seasonType()));
            }
    ...
    private void forceFinalizePriorWeek(int priorSeasonYear, int priorSeasonType, int priorWeekNum) {
        ...
        log.info("Force-finalize complete: {} finalized, {} skipped (still live/delayed)", finalized, skippedLive);
    }
    ...
    private void processLeague(
        ...
        if (priorWeek != null) {
            try {
                ...
                log.warn(
                        ...
                        leagueId, priorWeek.week(), e.getMessage());
            }
        }
        ...
        try {
            ...
            log.error(
                    ...
                    leagueId, currentWeekNum, e.getMessage());
        }
    }
