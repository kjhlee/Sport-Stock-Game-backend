...
import com.sportstocks.stockmarket.service.AthleteStockSyncService.SyncAthletesResult;
...
class AthleteStockSyncServiceTest {
    ...
    @BeforeEach
    void setUp() {
        when(pricingConfig.getBasePrices()).thenReturn(Map.of(
    ...
    private IngestionAthleteDto athlete(String espnId, String name, String position, String status, String teamId) {
